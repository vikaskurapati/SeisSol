...
namespace device_gen_code {
  ...
  void kernel::volume::execute() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 36, 9, 9, 1.0, I, 56, star(0), 9, 0.0, _tmp0, 36, offset_I, offset_star, offset__tmp0, num_elements);
    }
    {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 35, 1.0, kDivM(0), 56, _tmp0, 36, 1.0, Q, 56, offset_kDivM, offset__tmp0, offset_Q, num_elements);
    }
    _tmp2 = d_buffer0;
    {
    unsigned offset_I = I_offset;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 36, 9, 9, 1.0, I, 56, star(1), 9, 0.0, _tmp2, 36, offset_I, offset_star, offset__tmp2, num_elements);
    }
    {
    unsigned offset_kDivM = 0;
    unsigned offset__tmp2 = 324;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 35, 1.0, kDivM(1), 56, _tmp2, 36, 1.0, Q, 56, offset_kDivM, offset__tmp2, offset_Q, num_elements);
    }
    _tmp4 = d_buffer0;
    {
    unsigned offset_I = I_offset;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 36, 9, 9, 1.0, I, 56, star(2), 9, 0.0, _tmp4, 36, offset_I, offset_star, offset__tmp4, num_elements);
    }
    {
    unsigned offset_kDivM = 0;
    unsigned offset__tmp4 = 324;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 35, 1.0, kDivM(2), 56, _tmp4, 36, 1.0, Q, 56, offset_kDivM, offset__tmp4, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  ...
  void kernel::derivativeTaylorExpansion::execute1() {
    ...
    assert(dQ(1) != nullptr);
    assert(kernel::derivativeTaylorExpansion::num_elements != 0);
    device_copy_add_scale(35, 9, power, dQ(1) + 0, 36, 1.0, I + 0, 56, dQ_offset(1), I_offset, num_elements);
  }
  void kernel::derivativeTaylorExpansion::execute2() {
    ...
    assert(dQ(2) != nullptr);
    assert(kernel::derivativeTaylorExpansion::num_elements != 0);
    device_copy_add_scale(20, 9, power, dQ(2) + 0, 20, 1.0, I + 0, 56, dQ_offset(2), I_offset, num_elements);
  }
  void kernel::derivativeTaylorExpansion::execute3() {
    ...
    assert(dQ(3) != nullptr);
    assert(kernel::derivativeTaylorExpansion::num_elements != 0);
    device_copy_add_scale(10, 9, power, dQ(3) + 0, 12, 1.0, I + 0, 56, dQ_offset(3), I_offset, num_elements);
  }
  void kernel::derivativeTaylorExpansion::execute4() {
    ...
    assert(dQ(4) != nullptr);
    assert(kernel::derivativeTaylorExpansion::num_elements != 0);
    device_copy_add_scale(4, 9, power, dQ(4) + 0, 4, 1.0, I + 0, 56, dQ_offset(4), I_offset, num_elements);
  }
  void kernel::derivativeTaylorExpansion::execute5() {
    ...
    assert(dQ(5) != nullptr);
    assert(kernel::derivativeTaylorExpansion::num_elements != 0);
    device_copy_add_scale(1, 9, power, dQ(5) + 0, 4, 1.0, I + 0, 56, dQ_offset(5), I_offset, num_elements);
  }
  ...
  void kernel::derivative::execute1() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 36, 9, 53, 1.0, kDivMT(0), 36, dQ(0), 56, 0.0, _tmp0, 36, offset_kDivMT, offset_dQ + 1, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 324;
    unsigned offset_star = star_offset(0);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 36, 9, 9, 1.0, _tmp0, 36, star(0), 9, 0.0, dQ(1), 36, offset__tmp0, offset_star, offset_dQ, num_elements);
    }
    _tmp2 = d_buffer0;
    {
    unsigned offset_kDivMT = 0;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 36, 9, 54, 1.0, kDivMT(1), 36, dQ(0), 56, 0.0, _tmp2, 36, offset_kDivMT, offset_dQ + 1, offset__tmp2, num_elements);
    }
    {
    unsigned offset__tmp2 = 324;
    unsigned offset_star = star_offset(1);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 36, 9, 9, 1.0, _tmp2, 36, star(1), 9, 1.0, dQ(1), 36, offset__tmp2, offset_star, offset_dQ, num_elements);
    }
    _tmp4 = d_buffer0;
    {
    unsigned offset_kDivMT = 0;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 36, 9, 55, 1.0, kDivMT(2), 36, dQ(0), 56, 0.0, _tmp4, 36, offset_kDivMT, offset_dQ + 1, offset__tmp4, num_elements);
    }
    {
    unsigned offset__tmp4 = 324;
    unsigned offset_star = star_offset(2);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 36, 9, 9, 1.0, _tmp4, 36, star(2), 9, 1.0, dQ(1), 36, offset__tmp4, offset_star, offset_dQ, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::derivative::execute2() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 20, 9, 32, 1.0, kDivMT(0), 36, dQ(1), 36, 0.0, _tmp0, 20, offset_kDivMT, offset_dQ + 1, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 180;
    unsigned offset_star = star_offset(0);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 20, 9, 9, 1.0, _tmp0, 20, star(0), 9, 0.0, dQ(2), 20, offset__tmp0, offset_star, offset_dQ, num_elements);
    }
    _tmp2 = d_buffer0;
    {
    unsigned offset_kDivMT = 0;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 20, 9, 33, 1.0, kDivMT(1), 36, dQ(1), 36, 0.0, _tmp2, 20, offset_kDivMT, offset_dQ + 1, offset__tmp2, num_elements);
    }
    {
    unsigned offset__tmp2 = 180;
    unsigned offset_star = star_offset(1);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 20, 9, 9, 1.0, _tmp2, 20, star(1), 9, 1.0, dQ(2), 20, offset__tmp2, offset_star, offset_dQ, num_elements);
    }
    _tmp4 = d_buffer0;
    {
    unsigned offset_kDivMT = 0;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 20, 9, 34, 1.0, kDivMT(2), 36, dQ(1), 36, 0.0, _tmp4, 20, offset_kDivMT, offset_dQ + 1, offset__tmp4, num_elements);
    }
    {
    unsigned offset__tmp4 = 180;
    unsigned offset_star = star_offset(2);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 20, 9, 9, 1.0, _tmp4, 20, star(2), 9, 1.0, dQ(2), 20, offset__tmp4, offset_star, offset_dQ, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::derivative::execute3() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 12, 9, 17, 1.0, kDivMT(0), 36, dQ(2), 20, 0.0, _tmp0, 12, offset_kDivMT, offset_dQ + 1, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 108;
    unsigned offset_star = star_offset(0);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 12, 9, 9, 1.0, _tmp0, 12, star(0), 9, 0.0, dQ(3), 12, offset__tmp0, offset_star, offset_dQ, num_elements);
    }
    _tmp2 = d_buffer0;
    {
    unsigned offset_kDivMT = 0;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 12, 9, 18, 1.0, kDivMT(1), 36, dQ(2), 20, 0.0, _tmp2, 12, offset_kDivMT, offset_dQ + 1, offset__tmp2, num_elements);
    }
    {
    unsigned offset__tmp2 = 108;
    unsigned offset_star = star_offset(1);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 12, 9, 9, 1.0, _tmp2, 12, star(1), 9, 1.0, dQ(3), 12, offset__tmp2, offset_star, offset_dQ, num_elements);
    }
    _tmp4 = d_buffer0;
    {
    unsigned offset_kDivMT = 0;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 12, 9, 19, 1.0, kDivMT(2), 36, dQ(2), 20, 0.0, _tmp4, 12, offset_kDivMT, offset_dQ + 1, offset__tmp4, num_elements);
    }
    {
    unsigned offset__tmp4 = 108;
    unsigned offset_star = star_offset(2);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 12, 9, 9, 1.0, _tmp4, 12, star(2), 9, 1.0, dQ(3), 12, offset__tmp4, offset_star, offset_dQ, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::derivative::execute4() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 7, 1.0, kDivMT(0), 36, dQ(3), 12, 0.0, _tmp0, 4, offset_kDivMT, offset_dQ + 1, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 36;
    unsigned offset_star = star_offset(0);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 9, 1.0, _tmp0, 4, star(0), 9, 0.0, dQ(4), 4, offset__tmp0, offset_star, offset_dQ, num_elements);
    }
    _tmp2 = d_buffer0;
    {
    unsigned offset_kDivMT = 0;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 8, 1.0, kDivMT(1), 36, dQ(3), 12, 0.0, _tmp2, 4, offset_kDivMT, offset_dQ + 1, offset__tmp2, num_elements);
    }
    {
    unsigned offset__tmp2 = 36;
    unsigned offset_star = star_offset(1);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 9, 1.0, _tmp2, 4, star(1), 9, 1.0, dQ(4), 4, offset__tmp2, offset_star, offset_dQ, num_elements);
    }
    _tmp4 = d_buffer0;
    {
    unsigned offset_kDivMT = 0;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 9, 1.0, kDivMT(2), 36, dQ(3), 12, 0.0, _tmp4, 4, offset_kDivMT, offset_dQ + 1, offset__tmp4, num_elements);
    }
    {
    unsigned offset__tmp4 = 36;
    unsigned offset_star = star_offset(2);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 9, 1.0, _tmp4, 4, star(2), 9, 1.0, dQ(4), 4, offset__tmp4, offset_star, offset_dQ, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::derivative::execute5() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 1, 1.0, kDivMT(0), 36, dQ(4), 4, 0.0, _tmp0, 4, offset_kDivMT, offset_dQ + 1, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 36;
    unsigned offset_star = star_offset(0);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 9, 1.0, _tmp0, 4, star(0), 9, 0.0, dQ(5), 4, offset__tmp0, offset_star, offset_dQ, num_elements);
    }
    _tmp2 = d_buffer0;
    {
    unsigned offset_kDivMT = 0;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 2, 1.0, kDivMT(1), 36, dQ(4), 4, 0.0, _tmp2, 4, offset_kDivMT, offset_dQ + 1, offset__tmp2, num_elements);
    }
    {
    unsigned offset__tmp2 = 36;
    unsigned offset_star = star_offset(1);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 9, 1.0, _tmp2, 4, star(1), 9, 1.0, dQ(5), 4, offset__tmp2, offset_star, offset_dQ, num_elements);
    }
    _tmp4 = d_buffer0;
    {
    unsigned offset_kDivMT = 0;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 3, 1.0, kDivMT(2), 36, dQ(4), 4, 0.0, _tmp4, 4, offset_kDivMT, offset_dQ + 1, offset__tmp4, num_elements);
    }
    {
    unsigned offset__tmp4 = 36;
    unsigned offset_star = star_offset(2);
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, 9, 9, 1.0, _tmp4, 4, star(2), 9, 1.0, dQ(5), 4, offset__tmp4, offset_star, offset_dQ, num_elements);
    }
    tmp_manager.free();
  }
  ...
  void kernel::godunovState::execute0() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(0,0), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 9, 1.0, _tmp0, 52, godunovMatrix, 9, 0.0, godunovState, 52, offset__tmp0, offset_godunovMatrix, offset_godunovState, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::godunovState::execute1() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(1,0), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute2() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(2,0), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute3() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(3,0), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute4() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(0,1), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 9, 1.0, _tmp0, 52, godunovMatrix, 9, 1.0, godunovState, 52, offset__tmp0, offset_godunovMatrix, offset_godunovState, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::godunovState::execute5() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(1,1), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute6() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(2,1), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute7() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(3,1), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute8() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(0,2), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute9() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(1,2), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute10() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(2,2), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute11() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(3,2), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute12() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(0,3), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute13() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(1,3), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute14() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(2,3), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::godunovState::execute15() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 56, 1.0, V3mTo2n(3,3), 52, Q, 56, 0.0, _tmp0, 52, offset_V3mTo2n, offset_Q, offset__tmp0, num_elements);
    }
    {
    unsigned offset__tmp0 = 468;
    unsigned offset_godunovMatrix = godunovMatrix_offset;
  ...
  void kernel::nodalFlux::execute0() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 52, 9, 9, 1.0, godunovState, 52, fluxSolver, 9, 0.0, _tmp0, 52, offset_godunovState, offset_fluxSolver, offset__tmp0, num_elements);
    }
    {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(0,0), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute1() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(1,0), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute2() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(2,0), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute3() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(3,0), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute4() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(0,1), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute5() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(1,1), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute6() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(2,1), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute7() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(3,1), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute8() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(0,2), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute9() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(1,2), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute10() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(2,2), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute11() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(3,2), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute12() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(0,3), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute13() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(1,3), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute14() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(2,3), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
  void kernel::nodalFlux::execute15() {
    ...
    device_gemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 56, 9, 49, 1.0, V3mTo2nTWDivM(3,3), 56, _tmp0, 52, 1.0, Q, 56, offset_V3mTo2nTWDivM, offset__tmp0, offset_Q, num_elements);
    }
    tmp_manager.free();
  }
}
