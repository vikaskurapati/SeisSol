...
set(DEVICE_BACKEND "NONE" CACHE STRING "a backend that is going to be used for the device submodule")
set(DEVICE_BACKEDNS NONE CUDA DUMMY)
set_property(CACHE DEVICE_BACKEND PROPERTY STRINGS ${DEVICE_BACKEDNS})
...
check_parameter("DEVICE_BACKEND" ${DEVICE_BACKEND} "${DEVICE_BACKEDNS}")
